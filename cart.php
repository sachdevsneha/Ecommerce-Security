...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    foreach ($_SESSION["cart_array"] as $each_item) {
        ...
        $sql = mysqli_query($mysqli,"SELECT * FROM inventory_info WHERE item_id='$item_id' LIMIT 1");
        ...
        $x = $i + 1;
        $pp_checkout_btn .= '<input type="hidden" name="item_name_' . $x . '" value="' . $item_name . '">
       ...
       <input type="hidden" name="quantity_' . $x . '" value="' . $each_item['quantity'] . '">  ';
        ...
        $cartOutput .= "<tr>";
        $cartOutput .= '<td><a href="item_detail.php?id=' . $item_id . '">' . $item_name . '</a><br /><img src="inventory_images/' . $item_id . '.jpg" alt="' . $item_name. '" width="40" height="52" border="1" /></td>';
        $cartOutput .= '<td>' . $item_description . '</td>';
